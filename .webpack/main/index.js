...
const from_app_event_1 = __webpack_require__(/*! ./ipc-main/from-app-event */ "./src/ipc-main/from-app-event.ts");
...
const onAppReady = (0, from_app_event_1.fromAppEvent)(electron_1.app, "ready").pipe((0, operators_1.share)());
const onAppWindowAllClosed = (0, from_app_event_1.fromAppEvent)(electron_1.app, "window-all-closed").pipe((0, operators_1.share)());
const onAppActivate = onAppReady.pipe((0, operators_1.switchMap)(() => (0, from_app_event_1.fromAppEvent)(electron_1.app, "activate")), (0, operators_1.share)());
const onAppActivateNoWindows = onAppActivate.pipe((0, operators_1.filter)(() => electron_1.BrowserWindow.getAllWindows().length === 0), (0, operators_1.share)());
const onWinReady = (0, rxjs_1.merge)(onAppActivateNoWindows, onAppReady).pipe((0, operators_1.switchMap)(() => __awaiter(void 0, void 0, void 0, function* () {
    const win = new electron_1.BrowserWindow({
        width: 800,
        height: 600,
        webPreferences: {
            preload: '/Users/thanaditbuthong/Applications/Electron/electron-init/.webpack/renderer/main_window/preload.js',
...
/***/ "./src/ipc-main/from-app-event.ts":
/*!****************************************!*\
  !*** ./src/ipc-main/from-app-event.ts ***!
  \****************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
 ...
 * @returns Observable
 */
function fromAppEvent(app, eventName) {
    return new rxjs_1.Observable((subscriber) => {
...
exports.fromAppEvent = fromAppEvent;


/***/ }),

/***/ "./src/ipc-main/from-browser-event.ts":
/*!********************************************!*\
  !*** ./src/ipc-main/from-browser-event.ts ***!
  \********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.fromBrowserEvent = void 0;
const rxjs_1 = __webpack_require__(/*! rxjs */ "./node_modules/rxjs/dist/cjs/index.js");
function fromBrowserEvent(win, eventName) {
    return (0, rxjs_1.fromEventPattern)((handler) => {
...
exports.fromBrowserEvent = fromBrowserEvent;
